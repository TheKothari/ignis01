...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { Designation: @office.Designation, FID: @office.FID, OfficeNo: @office.OfficeNo, Status: @office.Status, bhk: @office.bhk } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { Designation: @office.Designation, FID: @office.FID, OfficeNo: @office.OfficeNo, Status: @office.Status, bhk: @office.bhk } }
